...
public class RuleManagementView {
    ...
    public RuleManagementView(GestionRule gestionRule) {
        ...
        grid.add(limitOperatorTypeLabel, 2, 2);
        GridPane.setMargin(limitOperatorTypeLabel, new Insets(0,0,0,50));
        grid.add(limitOperatorTypeField, 3, 2);
        ...
        grid.add(windowMinutesLabel, 2, 4);
        GridPane.setMargin(windowMinutesLabel, new Insets(0,0,0,50));
        grid.add(windowMinutesField, 3, 4);
        ...
        ruleStateColumn.setPrefWidth(120);
        ...
        groupingKeyNamesColumn.setPrefWidth(150);
        ...
        limitOperatorTypeColumn.setPrefWidth(150);
        ...
        windowMinutesColumn.setPrefWidth(130);
        ...
        ruleTableView.setStyle("-fx-background-color: #ADD8E6;");
        ruleTableView.setRowFactory(tv -> {
            TableRow<Rule> row = new TableRow<>();
            row.setStyle("-fx-background-color: #ADD8E6;"); // Light color for all
            // Color header
            ruleTableView.getColumns().forEach(column -> {
                column.setStyle("-fx-background-color: #ADD8E6;");  // Light blue for header
            ...
            row.itemProperty().addListener((obs, oldItem, newItem) -> {
                if (newItem != null) {
                    ...
                    if ("active".equalsIgnoreCase(newItem.getRuleState())) {
                        ...
                        row.setStyle("-fx-background-color: #ADD8E6;"); // Réinitialiser le style si aucun statut particulier
                    }
                }
            });
